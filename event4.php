...
<body>
    <div class="container">
        ...
        <div class="center-image">
            <img src="images/eg4.jpg" alt="" class="medium-image1"> <!-- Place the image in the center -->
        </div>
        <div class="registration-form">
            ...
            <form id="editEventForm" action="update_event.php" method="POST">
                ...
                <input type="hidden" id="eventId" name="eventId" value="4"> <!-- Replace "2" with the actual event ID -->
        
                <label for="eventName">Event Name:</label><br>
                <input type="text" id="eventName" name="eventName" value="Our Planet Needs You" style="width: 350px;" required>
                <br>
                <br>
                <label for="organizers">Organizers:</label><br>
                <input type="text" id="organizers" name="organizers" value="Malaysian Green Technology Corporation" style="width: 350px;" required>
                <br>
                <br>
                <label for="date">Date:</label><br>
                <input type="date" id="date" name="date" value="2024-05-19" style="width: 350px;" required>
                <br>
                <br>
                <label for="time">Time:</label><br>
                <input type="text" id="time" name="time" value="10:30 am - 1:00 pm" style="width: 350px;" required>
                <br>
                <br>
