...
<body>
    <div class="container">
        ...
        <div class="center-image">
            <img src="images/eg5.jpg" alt="" class="medium-image1"> <!-- Place the image in the center -->
        </div>
        <div class="registration-form">
            ...
            <form id="editEventForm" action="update_event.php" method="POST">
                ...
                <input type="hidden" id="eventId" name="eventId" value="5"> <!-- Replace "2" with the actual event ID -->
        
                <label for="eventName">Event Name:</label><br>
                <input type="text" id="eventName" name="eventName" value="Save the Planet, Don't Let It Frizzle!" style="width: 350px;" required>
                <br>
                <br>
                <label for="organizers">Organizers:</label><br>
                <input type="text" id="organizers" name="organizers" value="EcoFriend Malaysia" style="width: 350px;" required>
                <br>
                <br>
                <label for="date">Date:</label><br>
                <input type="date" id="date" name="date" value="2024-06-12" style="width: 350px;" required>
                <br>
                <br>
                <label for="time">Time:</label><br>
                <input type="text" id="time" name="time" value="9:30 am - 1:00 pm" style="width: 350px;" required>
                <br>
                <br>
